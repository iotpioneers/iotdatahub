...
import AddMember from "@/components/Dashboard/organization/AddMember";

export const metadata = {
  title: `Ten2Ten - Users | Dashboard `,
} satisfies Metadata;
      ...
      <Stack direction="row" spacing={3}>
        <Stack spacing={1} sx={{ flex: "1 1 auto" }}>
          ...
          <Stack direction="row" spacing={1} sx={{ alignItems: "center" }}>
            <div className="block md:flex w-full justify-between items-center">
              <AddMember />
