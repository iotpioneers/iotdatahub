...
// project imports
import TotalActionsAreaChartCard from "./TotalActionsAreaChartCard";
...
const UserActivityOverviewCard = ({ isLoading }: { isLoading: boolean }) => {
          ...
          <CardContent>
            <Grid container spacing={gridSpacing}>
              <Grid item xs={12}>
                ...
                >
                  <Grid item>
                    <Typography variant="h4">User Activity Overview</Typography>
                  </Grid>
                  <Grid item>
