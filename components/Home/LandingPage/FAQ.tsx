    ...
    >
      ...
      <Box sx={{ width: "100%" }}>
        ...
        >
          ...
          >
            <Typography component="h3" variant="subtitle2">
              How do I get started with setting up IoT devices on the platform?
            </Typography>
          </AccordionSummary>
          <AccordionDetails>
            <Typography
        ...
        >
          ...
          >
            <Typography component="h3" variant="subtitle2">
              How secure is the data on your platform?
            </Typography>
          </AccordionSummary>
          <AccordionDetails>
            <Typography
              ...
              sx={{ maxWidth: { sm: "100%", md: "70%" } }}
            >
              Data security is our top priority. Our platform implements
              state-of-the-art encryption and security protocols to protect your
              data from unauthorized access. We regularly update our security
              measures to stay ahead of potential threats, ensuring that your
              IoT data remains secure and confidential.
            </Typography>
          </AccordionDetails>
        </Accordion>
      </Box>
